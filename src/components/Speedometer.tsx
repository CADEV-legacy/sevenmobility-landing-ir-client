...
import { SECTION_TYPES } from '@/3ds';

export const Speedometer: React.FC = () => {
  const { sectionType, sectionProgress } = useIIIDMStore();

  const sectionTypeText = useMemo(() => {
    switch (sectionType) {
      case 'loading':
        return 'Loading';
      case 'intro':
  ...
  const percentage = useMemo(() => {
    switch (sectionType) {
      case 'loading':
        return sectionProgress / (SECTION_TYPES.length - 1);
      case 'intro':
        return (100 + sectionProgress) / (SECTION_TYPES.length - 1);
      case 'battery':
        return (200 + sectionProgress) / (SECTION_TYPES.length - 1);
      case 'bms':
        return (300 + sectionProgress) / (SECTION_TYPES.length - 1);
      case 'mcu':
        return (400 + sectionProgress) / (SECTION_TYPES.length - 1);
      case 'electricMotor':
        return (500 + sectionProgress) / (SECTION_TYPES.length - 1);
      case 'regenerativeBraking':
        return (600 + sectionProgress) / (SECTION_TYPES.length - 1);
      case 'userReview':
        return (700 + sectionProgress) / (SECTION_TYPES.length - 1);
      case 'detail':
        return 800 / (SECTION_TYPES.length - 1);
    }
  }, [sectionType, sectionProgress]);
...
const SpeedometerSVG: React.FC<SpeedometerSVGProps> = ({ percentage }) => {
    ...
    <SpeedometerSVGContainer>
      <svg
        ...
        <path
          ...
          strokeDasharray={615}
          d='M50.9,250C37,227.8,29,201.6,29,173.5C29,93.7,93.7,29,173.5,29C253.3,29,318,93.7,318,173.5
 c0,28.1-8,54.3-21.9,76.5'
        />
        <path
          id='inner-circle'
          className='st1'
          d='M174.1,238.9c34.8,0,63-28.2,63-63s-28.2-63-63-63c-34.8,0-63,28.2-63,63
 ...
 L282.5,236z'
        ...
        <g>
          <path
            className='st2'
            d='M59.6,253v-7.7h1.8v7.8c0,0.4,0.2,0.5,0.3,0.5c0.1,0,0.1,0,0.2,0l0.2,1.3c-0.2,0.1-0.5,0.2-0.9,0.2
   C60.1,255,59.6,254.2,59.6,253z'
          />
          <path
            className='st2'
            d='M63,251.5c0-2.2,1.5-3.5,3.2-3.5s3.2,1.3,3.2,3.5c0,2.2-1.5,3.5-3.2,3.5S63,253.7,63,251.5z M67.7,251.5
   c0-1.3-0.5-2.1-1.4-2.1s-1.4,0.8-1.4,2.1c0,1.3,0.5,2.1,1.4,2.1S67.7,252.8,67.7,251.5z'
          />
          <path
            className='st2'
            d='M70.4,253c0-1.4,1.2-2.2,3.9-2.5c0-0.7-0.3-1.2-1.2-1.2c-0.6,0-1.2,0.3-1.8,0.6l-0.6-1.2
   ...
   v-1.4c-1.6,0.2-2.2,0.7-2.2,1.3c0,0.5,0.4,0.8,0.9,0.8C73.5,253.7,73.9,253.4,74.3,253z'
          ...
          <path
            className='st2'
            d='M77.5,251.5c0-2.2,1.4-3.5,2.8-3.5c0.8,0,1.2,0.3,1.7,0.7l-0.1-1.1v-2.4h1.8v9.6h-1.4l-0.1-0.7h0
   ...
   c0,1.4,0.5,2.1,1.4,2.1C81.1,253.6,81.5,253.4,81.9,252.9z'
          ...
          <path
            className='st2'
            d='M85.4,246.1c0-0.6,0.4-1,1-1c0.6,0,1,0.4,1,1c0,0.6-0.4,1-1,1C85.9,247.1,85.4,246.7,85.4,246.1z M85.6,248.2
   h1.8v6.7h-1.8V248.2z'
          />
          <path
            className='st2'
            d='M89.2,248.2h1.4l0.1,0.9h0c0.6-0.6,1.3-1.1,2.2-1.1c1.5,0,2.1,1,2.1,2.7v4.2h-1.8v-4c0-1-0.3-1.4-0.9-1.4
   c-0.6,0-0.9,0.3-1.4,0.8v4.6h-1.8V248.2z'
          />
          <path
            className='st2'
            d='M96.5,256.1c0-0.6,0.3-1,1-1.4v-0.1c-0.3-0.2-0.6-0.6-0.6-1.1c0-0.5,0.3-1,0.8-1.3v0c-0.5-0.3-0.9-1-0.9-1.8
   ...
   c0,0.8,0.5,1.2,1.1,1.2C100,251.7,100.5,251.2,100.5,250.4z'
        ...
        <g>
          <path
            className='st2'
            d='M34.9,179.9c0-0.6,0.4-1,1-1c0.6,0,1,0.4,1,1c0,0.6-0.4,1-1,1C35.3,180.9,34.9,180.5,34.9,179.9z M35,182h1.8
   v6.7H35V182z'
          />
          <path
            className='st2'
            d='M38.7,182h1.4l0.1,0.9h0c0.6-0.6,1.3-1.1,2.2-1.1c1.5,0,2.1,1,2.1,2.7v4.2h-1.8v-4c0-1-0.3-1.4-0.9-1.4
   c-0.6,0-0.9,0.3-1.4,0.8v4.6h-1.8V182z'
          />
          <path
            className='st2'
            d='M46.6,186.3v-3h-0.9V182l1-0.1l0.2-1.8h1.5v1.8h1.7v1.4h-1.7v3c0,0.8,0.3,1.1,0.9,1.1c0.2,0,0.5-0.1,0.7-0.1
   l0.3,1.3c-0.4,0.1-0.8,0.3-1.4,0.3C47.3,188.8,46.6,187.8,46.6,186.3z'
          />
          <path
            className='st2'
            d='M51.4,182h1.4l0.1,1.2h0c0.5-0.9,1.2-1.4,1.9-1.4c0.4,0,0.6,0.1,0.8,0.1l-0.3,1.5c-0.2-0.1-0.4-0.1-0.7-0.1
   c-0.5,0-1.2,0.3-1.5,1.3v4h-1.8V182z'
          />
          <path
            className='st2'
            d='M56.1,185.3c0-2.2,1.5-3.5,3.2-3.5s3.2,1.3,3.2,3.5c0,2.2-1.5,3.5-3.2,3.5S56.1,187.5,56.1,185.3z M60.7,185.3
   c0-1.3-0.5-2.1-1.4-2.1s-1.4,0.8-1.4,2.1c0,1.3,0.5,2.1,1.4,2.1S60.7,186.6,60.7,185.3z'
        ...
        <g>
          <path
            className='st2'
            d='M45.7,123.2L45.7,123.2l-0.2,0.7h-1.4v-9.6h1.8v2.4l0,1.1c0.5-0.5,1.2-0.8,1.9-0.8c1.7,0,2.7,1.4,2.7,3.4
   ...
   c0.4,0.4,0.9,0.5,1.2,0.5C47.9,122.6,48.6,121.9,48.6,120.4z'
          ...
          <path
            className='st2'
            d='M51.4,122c0-1.4,1.2-2.2,3.9-2.5c0-0.7-0.3-1.2-1.2-1.2c-0.6,0-1.2,0.3-1.8,0.6l-0.6-1.2
   ...
   v-1.4c-1.6,0.2-2.2,0.7-2.2,1.3c0,0.5,0.4,0.8,0.9,0.8C54.4,122.7,54.8,122.4,55.2,122z'
          ...
          <path
            className='st2'
            d='M58.8,121.5v-3h-0.9v-1.3l1-0.1l0.2-1.8h1.5v1.8h1.7v1.4h-1.7v3c0,0.8,0.3,1.1,0.9,1.1c0.2,0,0.5-0.1,0.7-0.1
   l0.3,1.3c-0.4,0.1-0.8,0.3-1.4,0.3C59.4,124,58.8,123,58.8,121.5z'
          />
          <path
            className='st2'
            d='M63.6,121.5v-3h-0.9v-1.3l1-0.1l0.2-1.8h1.5v1.8H67v1.4h-1.7v3c0,0.8,0.3,1.1,0.9,1.1c0.2,0,0.5-0.1,0.7-0.1
   l0.3,1.3c-0.4,0.1-0.8,0.3-1.4,0.3C64.2,124,63.6,123,63.6,121.5z'
          />
          <path
            className='st2'
            d='M67.7,120.5c0-2.2,1.5-3.5,3.1-3.5c1.8,0,2.8,1.4,2.8,3.2c0,0.3,0,0.7-0.1,0.8h-4.1c0.1,1.1,0.9,1.7,1.9,1.7
   ...
   c-0.7,0-1.3,0.5-1.5,1.5H72.2z'
          ...
          <path
            className='st2'
            d='M75.1,117.2h1.4l0.1,1.2h0c0.5-0.9,1.2-1.4,1.9-1.4c0.4,0,0.6,0.1,0.8,0.1l-0.3,1.5c-0.2-0.1-0.4-0.1-0.7-0.1
   c-0.5,0-1.2,0.3-1.5,1.3v4h-1.8V117.2z'
          />
          <path
            className='st2'
            d='M80.2,126.4l0.3-1.4c0.1,0,0.3,0.1,0.5,0.1c0.7,0,1.1-0.4,1.3-1l0.1-0.4l-2.6-6.6h1.8l1.1,3.1
   ...
   C80.7,126.6,80.4,126.5,80.2,126.4z'
        ...
        <g>
          <path
            className='st2'
            d='M85.1,75L85.1,75l-0.2,0.7h-1.4v-9.6h1.8v2.4l0,1.1c0.5-0.5,1.2-0.8,1.9-0.8c1.7,0,2.7,1.4,2.7,3.4
   ...
   c0.4,0.4,0.9,0.5,1.2,0.5C87.3,74.4,87.9,73.7,87.9,72.2z'
          ...
          <path
            className='st2'
            d='M91.2,69h1.4l0.1,0.9h0c0.6-0.6,1.2-1.1,2.1-1.1c1,0,1.5,0.4,1.8,1.2c0.6-0.6,1.3-1.2,2.1-1.2
   ...
   c-0.4,0-0.8,0.3-1.3,0.8v4.6h-1.8V69z'
          ...
          <path
            className='st2'
            d='M102.2,74.9l0.8-1.1c0.6,0.5,1.2,0.7,1.8,0.7c0.7,0,1-0.3,1-0.7c0-0.5-0.7-0.7-1.4-1c-0.9-0.3-1.8-0.8-1.8-2
   ...
   c0.9,0.3,1.9,0.8,1.9,2c0,1.2-0.9,2.1-2.7,2.1C103.8,75.8,102.8,75.4,102.2,74.9z'
        ...
        <g>
          <path
            className='st2'
            d='M145.7,42.5h1.4l0.1,0.9h0c0.6-0.6,1.2-1.1,2.1-1.1c1,0,1.5,0.4,1.8,1.2c0.6-0.6,1.3-1.2,2.1-1.2
   c1.4,0,2.1,1,2.1,2.7v4.2h-1.8v-4c0-1-0.3-1.4-0.9-1.4c-0.4,0-0.8,0.3-1.3,0.8v4.6h-1.8v-4c0-1-0.3-1.4-0.9-1.4
   c-0.4,0-0.8,0.3-1.3,0.8v4.6h-1.8V42.5z'
          />
          <path
            className='st2'
            d='M156.8,45.8c0-2.2,1.6-3.5,3.4-3.5c0.8,0,1.5,0.3,2,0.7l-0.8,1.1c-0.3-0.3-0.6-0.4-1-0.4c-1,0-1.7,0.8-1.7,2.1
   c0,1.3,0.7,2.1,1.7,2.1c0.5,0,0.9-0.2,1.3-0.5l0.7,1.2c-0.6,0.6-1.5,0.8-2.2,0.8C158.3,49.3,156.8,48,156.8,45.8z'
          />
          <path
            className='st2'
            d='M163.5,46.7v-4.2h1.8v4c0,1,0.3,1.4,0.9,1.4c0.6,0,0.9-0.2,1.4-0.8v-4.5h1.8v6.7h-1.4l-0.1-1h0
   c-0.6,0.7-1.2,1.1-2.1,1.1C164.1,49.3,163.5,48.3,163.5,46.7z'
        ...
        <g>
          <path
            className='st2'
            d='M201.8,52.9h1.4l0.1,0.9h0c0.6-0.6,1.2-1.1,2.1-1.1c1,0,1.5,0.4,1.8,1.2c0.6-0.6,1.3-1.2,2.1-1.2
   c1.4,0,2.1,1,2.1,2.7v4.2h-1.8v-4c0-1-0.3-1.4-0.9-1.4c-0.4,0-0.8,0.3-1.3,0.8v4.6h-1.8v-4c0-1-0.3-1.4-0.9-1.4
   c-0.4,0-0.8,0.3-1.3,0.8v4.6h-1.8V52.9z'
          />
          <path
            className='st2'
            d='M212.9,56.2c0-2.2,1.5-3.5,3.2-3.5c1.7,0,3.2,1.3,3.2,3.5c0,2.2-1.5,3.5-3.2,3.5
   ...
   C217.1,58.3,217.6,57.5,217.6,56.2z'
          ...
          <path
            className='st2'
            d='M220.8,57.2v-3h-0.9v-1.3l1-0.1l0.2-1.8h1.5v1.8h1.7v1.4h-1.7v3c0,0.8,0.3,1.1,0.9,1.1c0.2,0,0.5-0.1,0.7-0.1
   l0.3,1.3c-0.4,0.1-0.8,0.3-1.4,0.3C221.4,59.7,220.8,58.7,220.8,57.2z'
          />
          <path
            className='st2'
            d='M224.9,56.2c0-2.2,1.5-3.5,3.2-3.5c1.7,0,3.2,1.3,3.2,3.5c0,2.2-1.5,3.5-3.2,3.5
   ...
   C229.1,58.3,229.6,57.5,229.6,56.2z'
          ...
          <path
            className='st2'
            d='M232.9,52.9h1.4l0.1,1.2h0c0.5-0.9,1.2-1.4,1.9-1.4c0.4,0,0.6,0.1,0.8,0.1l-0.3,1.5c-0.2-0.1-0.4-0.1-0.7-0.1
   c-0.5,0-1.2,0.3-1.5,1.3v4h-1.8V52.9z'
        ...
        <g>
          <path
            className='st2'
            d='M269.8,95.8h3.1c1.9,0,3.3,0.7,3.3,2.7c0,1.3-0.7,2.2-1.7,2.6l2.1,3.6h-2l-1.8-3.4h-1.2v3.4h-1.8V95.8z
    M272.7,99.9c1.1,0,1.8-0.5,1.8-1.4c0-1-0.6-1.3-1.8-1.3h-1.2v2.7H272.7z'
          />
          <path
            className='st2'
            d='M280.7,95.8h2.9c1.8,0,3.2,0.5,3.2,2.2c0,0.8-0.5,1.7-1.2,1.9v0.1c1,0.2,1.7,0.9,1.7,2.1
   ...
   c1.2,0,1.9-0.4,1.9-1.4c0-0.9-0.6-1.2-1.9-1.2h-1.2v2.6H283.7z'
        ...
        <g>
          <path
            className='st2'
            d='M246.1,166v-4.2h1.8v4c0,1,0.3,1.4,0.9,1.4c0.6,0,0.9-0.2,1.4-0.8v-4.5h1.8v6.7h-1.4l-0.1-1h0
   c-0.6,0.7-1.2,1.1-2.1,1.1C246.7,168.6,246.1,167.6,246.1,166z'
          />
          <path
            className='st2'
            d='M253.2,167.7l0.8-1.1c0.6,0.5,1.2,0.7,1.8,0.7c0.7,0,1-0.3,1-0.7c0-0.5-0.7-0.7-1.4-1c-0.9-0.3-1.8-0.8-1.8-2
   c0-1.2,1-2.1,2.5-2.1c1,0,1.7,0.4,2.3,0.8l-0.8,1.1c-0.5-0.3-0.9-0.6-1.4-0.6c-0.6,0-0.9,0.3-0.9,0.6c0,0.5,0.6,0.7,1.3,0.9
   c0.9,0.3,1.9,0.8,1.9,2c0,1.2-0.9,2.1-2.7,2.1C254.8,168.6,253.8,168.2,253.2,167.7z'
          />
          <path
            className='st2'
            d='M259.3,165.1c0-2.2,1.5-3.5,3.1-3.5c1.8,0,2.8,1.4,2.8,3.2c0,0.3,0,0.7-0.1,0.8H261c0.1,1.1,0.9,1.7,1.9,1.7
   ...
   c-0.7,0-1.3,0.5-1.5,1.5H263.7z'
          ...
          <path
            className='st2'
            d='M266.7,161.8h1.4l0.1,1.2h0c0.5-0.9,1.2-1.4,1.9-1.4c0.4,0,0.6,0.1,0.8,0.1l-0.3,1.5c-0.2-0.1-0.4-0.1-0.7-0.1
   c-0.5,0-1.2,0.3-1.5,1.3v4h-1.8V161.8z'
          />
          <path
            className='st2'
            d='M274.7,161.8h1.4l0.1,1.2h0c0.5-0.9,1.2-1.4,1.9-1.4c0.4,0,0.6,0.1,0.8,0.1l-0.3,1.5c-0.2-0.1-0.4-0.1-0.7-0.1
   c-0.5,0-1.2,0.3-1.5,1.3v4h-1.8V161.8z'
          />
          <path
            className='st2'
            d='M279.3,165.1c0-2.2,1.5-3.5,3.1-3.5c1.8,0,2.8,1.4,2.8,3.2c0,0.3,0,0.7-0.1,0.8H281c0.1,1.1,0.9,1.7,1.9,1.7
   ...
   c-0.7,0-1.3,0.5-1.5,1.5H283.8z'
          ...
          <path
            className='st2'
            d='M285.9,161.8h1.8l1,3.3c0.2,0.7,0.4,1.4,0.5,2h0.1c0.2-0.7,0.4-1.4,0.5-2l1-3.3h1.7l-2.2,6.7h-2L285.9,161.8z'
          />
          <path
            className='st2'
            d='M293.4,159.7c0-0.6,0.4-1,1-1c0.6,0,1,0.4,1,1c0,0.6-0.4,1-1,1C293.9,160.7,293.4,160.3,293.4,159.7z
    M293.6,161.8h1.8v6.7h-1.8V161.8z'
          />
          <path
            className='st2'
            d='M296.8,165.1c0-2.2,1.5-3.5,3.1-3.5c1.8,0,2.8,1.4,2.8,3.2c0,0.3,0,0.7-0.1,0.8h-4.1c0.1,1.1,0.9,1.7,1.9,1.7
   ...
   c-0.7,0-1.3,0.5-1.5,1.5H301.2z'
          ...
          <path
            className='st2'
            d='M303.5,161.8h1.8l0.7,3.3c0.1,0.7,0.2,1.3,0.3,2h0c0.1-0.7,0.3-1.3,0.4-2l0.8-3.3h1.6l0.8,3.3
   ...
   c-0.1,0.7-0.2,1.3-0.4,2l-0.7,2.9h-2L303.5,161.8z'
        ...
        <g>
          <path
            className='st2'
            d='M269.3,225.7c0-2.2,1.4-3.5,2.8-3.5c0.8,0,1.2,0.3,1.7,0.7l-0.1-1.1v-2.4h1.8v9.6H274l-0.1-0.7h0
   ...
   c0,1.4,0.5,2.1,1.4,2.1C272.9,227.8,273.3,227.6,273.7,227.1z'
          ...
          <path
            className='st2'
            d='M277,225.7c0-2.2,1.5-3.5,3.1-3.5c1.8,0,2.8,1.4,2.8,3.2c0,0.3,0,0.7-0.1,0.8h-4.1c0.1,1.1,0.9,1.7,1.9,1.7
   ...
   c-0.7,0-1.3,0.5-1.5,1.5H281.4z'
          ...
          <path
            className='st2'
            d='M284.5,226.7v-3h-0.9v-1.3l1-0.1l0.2-1.8h1.5v1.8h1.7v1.4h-1.7v3c0,0.8,0.3,1.1,0.9,1.1c0.2,0,0.5-0.1,0.7-0.1
   l0.3,1.3c-0.4,0.1-0.8,0.3-1.4,0.3C285.1,229.2,284.5,228.2,284.5,226.7z'
          />
          <path
            className='st2'
            d='M288.6,227.2c0-1.4,1.2-2.2,3.9-2.5c0-0.7-0.3-1.2-1.2-1.2c-0.6,0-1.2,0.3-1.8,0.6l-0.6-1.2
   c0.8-0.5,1.8-0.9,2.8-0.9c1.7,0,2.6,1,2.6,3v3.9h-1.4l-0.1-0.7h0c-0.6,0.5-1.3,0.9-2,0.9C289.4,229.2,288.6,228.4,288.6,227.2z
    M292.5,227.2v-1.4c-1.6,0.2-2.2,0.7-2.2,1.3c0,0.5,0.4,0.8,0.9,0.8C291.7,227.8,292.1,227.6,292.5,227.2z'
          ...
          <path
            className='st2'
            d='M295.9,220.3c0-0.6,0.4-1,1-1c0.6,0,1,0.4,1,1c0,0.6-0.4,1-1,1C296.3,221.2,295.9,220.9,295.9,220.3z
    M296.1,222.3h1.8v6.7h-1.8V222.3z'
          />
          <path
            className='st2'
            d='M299.7,227.2v-7.7h1.8v7.8c0,0.4,0.2,0.5,0.3,0.5c0.1,0,0.1,0,0.2,0l0.2,1.3c-0.2,0.1-0.5,0.2-0.9,0.2
